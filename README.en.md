...
**🖥️ Desktop Host (Electron 29)**
- **Main process**: Electron 29 · Node 20
- **Local file server**: Fastify · per-transfer AbortController cancellation
- **Data storage**: better-sqlite3

**🔗 Relay Server**
- **HTTP/WS service**: Fastify · `@fastify/websocket`
...
**📦 Shared Protocol**
- **Protocol types**: TypeScript interfaces · runtime message validators · path security
